...
{"name":"i3-proc","interval_secs":3,"script":"false >/dev/null 2>&1 || echo DOWN","agent":"build","prompt_template":"Proc: {output}","trigger_mode":"event_only","enabled":true,"cooldown_secs":0}
EJSON
