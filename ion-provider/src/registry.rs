...
impl ProviderFactory for BuiltinProviderFactory {
    fn create(&self, api: &str) -> Option<Box<dyn ApiProvider>> {
        match api {
            ...
            "azure-openai-responses" => Some(Box::new(
                super::azure::AzureOpenAIResponsesProvider::default(),
            )),
            ...
            "cloudflare-workers-ai" => {
                Some(Box::new(super::cloudflare::CloudflareWorkersAIProvider))
            }
...
impl ApiRegistry {
    ...
    pub fn register_builtins(&mut self) {
        self.register(
            "openai-completions",
            Box::new(super::openai::OpenAICompletionsProvider),
        );
        self.register(
            "anthropic-messages",
            Box::new(super::anthropic::AnthropicMessagesProvider),
        );
        self.register(
            "openai-responses",
            Box::new(super::openai_responses::OpenAIResponsesProvider),
        );
        self.register(
            "openai-codex-responses",
            Box::new(super::codex::CodexResponsesProvider),
        );
        self.register(
            "azure-openai-responses",
            Box::new(super::azure::AzureOpenAIResponsesProvider::default()),
        );
        self.register(
            "google-generative-ai",
            Box::new(super::google::GoogleGenerativeAIProvider),
        );
        self.register(
            "google-vertex",
            Box::new(super::vertex::GoogleVertexProvider),
        );
        self.register(
            "mistral-conversations",
            Box::new(super::mistral::MistralProvider),
        );
        self.register(
            "cloudflare-workers-ai",
            Box::new(super::cloudflare::CloudflareWorkersAIProvider),
        );
        self.register(
            "bedrock-converse-stream",
            Box::new(super::bedrock::BedrockConverseProvider),
        );
    }
}
                            ...
                            for m in models {
                                if let Some(id) = m.get("id").and_then(|v| v.as_str()) {
                                    ...
                                    let context_window = m
                                        ...
                                        .unwrap_or(128000);
                                    let max_tokens =
                                        m.get("maxTokens").and_then(|v| v.as_u64()).unwrap_or(8192);
                                    let cost_input = m
                                        .get("cost")
