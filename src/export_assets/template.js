    (function() {
      ...
      // Session content is untrusted. Escape raw HTML before Markdown parsing so
      // a shared standalone export cannot execute tags or event handlers from a
      // prompt, model response, tool output, Custom entry, or branch summary.
