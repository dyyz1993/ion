...
| file_snapshot_ci (CLI E2E) | 33 | Group A-K 全过（0 skip）：object_store 去重[+zstd]/scanner 目录扫描/diff 生成/GC/4 RPC 端到端/worktree 并行/restore 恢复[+XL3 full mode]/审批 harness+RPC[+J2-J6 全 pass]/事件推送 subscribe[+K1 ApprovalRequest/K2 approved/K3 rejected/K4 extension标识/K5 deny注入] |
...
| **测试覆盖合计** | **915** | 全部通过 ✅（含 E2E 12 Group 156 case + file_snapshot CI 33 case 全 0 skip + 事件推送 subscribe 断言 + zstd + XL1/XL3/XL4） |
