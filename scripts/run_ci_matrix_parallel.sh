...
SKIP_LIST="apple_container_ci mcp_ci hooks_agent_real streaming_replay_ci self_heal_ci goal_supervisor_ci goal_evolver_ci monitor_ci scenario2_ci team_e2e workflow_ci"
