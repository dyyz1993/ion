...
TASKS=(
    ...
    "SE-18|src/agent/extension.rs|Add a pub fn loaded_extension_names(&self) -> Vec<String> to ExtensionRunner that returns the list of loaded extension names. Iterate self.extensions, collect keys.|Test: create registry, register known extensions, call loaded_extension_names, verify|test_loaded_extension_names|feat(ext): loaded_extension_names method + test"
