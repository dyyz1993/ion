...
>
> handler 完成度：command ✅ / http ✅ / agent ✅（真能调工具）/ prompt ✅（调 ApiRegistry 做 LLM 判断）/ mcp_tool 🔧 stub（需 McpManager）
...
| 5 种 handler 执行引擎 | command ✅ / http ✅ / prompt ✅ / **agent ✅(真传 tools)** / mcp_tool 🔧 | ✅ 已实现（4/5 完整） |
